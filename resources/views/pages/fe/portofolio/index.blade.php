        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">{{ app()->getLocale() == 'id' ? 'Portofolio' : 'Portofolio' }}</h2>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project details-->
                                    <h2 id="portofolio_project_name" class="text-uppercase" style="word-wrap: break-word; overflow-wrap: break-word; hyphens: auto;">{{ app()->getLocale() == 'id' ? 'Nama Proyek' : 'Project Name' }}</h2>
                         ...
                         <div class="col-lg-4 col-sm-6 mb-4">
                            <div class="portfolio-item">
                                <a class="portfolio-link" data-slug="${portofolio.slug}" data-bs-toggle="modal" href="#portfolioModal">
                                    ...
                                    <img class="img-fluid" src="${portofolio.image}" alt="${portofolio.project_name}" height="450px"/>
                                </a>
